...
export default function ContactButton() {
  ...
  return (
    <div className="fixed bottom-20 right-5 z-50 flex flex-row  gap-2 md:hidden">
      ...
      <AnimatePresence>
        {showScrollText && (
          <motion.div
            ...
            className="bg-white rounded-full shadow-lg px-3 py-1 flex items-center justify-center h-10  mt-2"
