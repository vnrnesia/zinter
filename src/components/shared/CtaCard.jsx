  ...
  return (
    <section className="w-full flex justify-center items-center py-16">
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative bg-gradient-to-r from-[#006FDC] to-[#11B4EC] shadow-2xl overflow-hidden w-full max-w-[1250px] px-8 py-10 rounded-none min-h-[500px] sm:rounded-3xl sm:min-h-[400px]"
      >
        <img
          src={World1}
          alt="Background"
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center lg:mt-10">
          <motion.div
