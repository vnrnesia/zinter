    ...
    <section className="flex justify-center items-center py-16">
      <section className="w-full flex justify-center items-center py-16">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative bg-gradient-to-r from-[#006FDC] to-[#11B4EC] shadow-2xl overflow-hidden w-full max-w-[1250px] px-8 py-10 md:rounded-3xl min-h-[400px]"
        >
          <img
            src={World1}
            alt="Background"
          ...
          <div className="relative flex flex-col md:grid md:grid-cols-2 gap-12 items-start">
            <div className="flex justify-center items-center md:order-2">
              <img
                src={international}
                alt="International"
                className="max-w-full md:max-w-[80%] max-h-[90%]"
              />
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-white w-full flex flex-col justify-between h-full order-1 md:order-1"
            >
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-5 text-left">{title}</h2>
                <p className="text-lg opacity-80 mb-6 text-left">{text}</p>
              </div>

              <div className="flex flex-col items-start w-full max-w-md">
                <p className="text-white text-lg font-medium mb-3 text-left">
