  ...
  return (
    <>
      <section className="py-16 bg-gradient-to-r from-[#006FDC] to-[#11B4EC] border-b-4 border-b-[#676767] gap-30">
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-4 max-w-[90%] 2xl:max-w-7xl">
          <div className="lg:w-1/2 space-y-4 md:space-y-6 text-white text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl font-normal px-4 lg:px-0">
              Промышленный ВЭД консталтинг Доставка санкционных товаров из
              Европы Доставка любых грузов из Китая
            </p>

            <ul className="space-y-2 md:space-y-3 px-2 lg:px-0 inline-flex flex-col items-start">
              <li className="flex items-center justify-center lg:justify-start">
                <svg className="w-6 h-6 md:w-7 md:h-7 text-[#FFC23E] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-base md:text-lg">Подбираем поставщиков</span>
              </li>
              <li className="flex items-center justify-center lg:justify-start">
                <svg className="w-6 h-6 md:w-7 md:h-7 text-[#FFC23E] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              ...
              <li className="flex items-center justify-center lg:justify-start">
                ...
                <span className="text-base md:text-lg">Доставляем грузы от 20 кг</span>
              </li>
            </ul>

            <div className="pt-2 flex justify-center lg:justify-start">
              <div className="pt-2 flex flex-col items-center lg:items-start group relative">
                <div className="flex w-full bg-gray-100 rounded-md shadow-sm cursor-pointer">
                  <button
                    type="button"
                    onClick={() => setIsOpen(true)}
                    className="relative flex items-center bg-white hover:bg-gray-100 text-gray-900 pl-8 pr-14 py-2 rounded-lg font-medium transition-colors shadow-md overflow-visible"
                  >
                    Обратитесь к нам
                    <img
                      src={PhoneIcon}
                ...
                <div className="flex gap-2 mt-3 lg:absolute lg:left-full lg:top-[25%] lg:transform lg:-translate-y-1/2 lg:ml-12">
                  <a href="https://wa.me/79178899457" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455.731 455.731" className="w-12 h-12 rounded-md">
                      <g>
                  ...
                  <a href="https://t.me/yourtelegrambot" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 h-12 rounded-md">
                  ...
                  <a href="mailto:zinter@zinter.com" className="w-12 h-12 flex items-center justify-center shadow-lg transform transition-all hover:scale-110 hover:shadow-xl">
                    <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 rounded-md">
