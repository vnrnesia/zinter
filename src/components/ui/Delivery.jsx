  ...
  const deliveryOptions = [
    {
      ...
      title: "Авиадоставка",
      description:
        "В услугу входит загрузка, авиаперелет, таможня и доставка товара на склад",
    ...
    },
    {
      ...
      title: "Автодоставка",
      description:
        "Формируем сборные грузы клиентов и выпускаем машины ежедневно",
    ...
    },
    {
      ...
      title: "ЖД доставка",
      description:
        "Способ транспортировки снижает стоимость на перевозку любого груза",
    ...
    },
    {
      ...
      description:
        "Отправляем в стальном контейнере. Вероятность повреждений минимальна",
