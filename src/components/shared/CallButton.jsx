...
export default function CallButton() {
  return (
    <>
      <div className="pt-2 flex justify-center lg:justify-start group relative">
        ...
        <div className="absolute left-full top-1/2 transform -translate-y-1/2 ml-12 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
